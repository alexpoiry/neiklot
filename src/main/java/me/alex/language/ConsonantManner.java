...
public enum ConsonantManner {
    ...
    STOP(new HashSet<>(Arrays.asList("p", "b", "p̪", "b̪", "t̼", "d̼", "t", "d", "ʈ", "ɖ", "c", "ɟ", "k", "ɡ", "q", "ɢ", "ʡ", "ʔ"))),
    SIBILANT_AFFRICATE(new HashSet<>(Arrays.asList("ts", "dz", "t̠ʃ", "d̠ʒ", "ʈʂ", "ɖʐ", "tɕ", "dʑ"))),
    NON_SIBILANT_AFFRICATE(new HashSet<>(Arrays.asList("pɸ", "bβ", "p̪f", "b̪v", "t̪θ", "d̪ð", "tɹ̝̊", "dɹ̝", /*"t̠ɹ̠̊˔", "d̠ɹ̠˔,*/ "cç", "ɟʝ", "kx", "ɡɣ", "qχ", "ɢʁ", "ʡʢ", "ʔh"))),
    SIBILANT_FRICATIVE(new HashSet<>(Arrays.asList("s", "z", "ʃ", "ʒ", "ʂ", "ʐ", "ɕ", "ʑ"))),
    NON_SIBILANT_FRICATIVE(new HashSet<>(Arrays.asList("ɸ", "β", "f", "v", "θ̼", "ð̼", "θ", "ð", "θ̠", "ð̠", /*"ɹ̠̊˔", "ɹ̠˔", "ɻ˔,*/ "ç", "ʝ", "x", "ɣ", "χ", "ʁ", "ħ", "ʕ", "h", "ɦ"))),
    APPROXIMANT(new HashSet<>(Arrays.asList("ʋ̥", "ʋ", "ɹ̥", "ɹ", "ɻ̊", "ɻ", "j̊", "j", "ɰ̊", "ɰ", "ʔ̞"))),
